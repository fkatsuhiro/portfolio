...
export default function PageLinkBlock({ href, title, desc1, desc2 }: PageLinkBlockProps) {
  return (
    ...
    >
      <h3 className="text-2xl font-bold mb-2 transition-colors mt-5 ">{title}</h3>
      <p className="text-gray-500 dark:text-gray-400 mb-1">{desc1}</p>
      <p className="text-gray-500 dark:text-gray-400 mb-5">{desc2}</p>
    </a>
  );
}
