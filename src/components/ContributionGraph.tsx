        ...
        <div>
          ...
          <div className="overflow-x-auto pb-2">
            <svg
              ...
              style={{ width: Math.min(svgWidth, 728), height: 'auto', display: 'block' }}
            >
          ...
          <div className="flex items-center gap-1 mt-2 justify-end text-xs text-gray-400 dark:text-gray-500">
            <span>Less</span>
            {colors.map((c, i) => (
              <svg key={i} width={CELL_SIZE} height={CELL_SIZE} viewBox={`0 0 ${CELL_SIZE} ${CELL_SIZE}`} aria-hidden="true">
